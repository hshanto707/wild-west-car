...
const Hero = () => {
  return (
    <div className="hero">
      ...
      <div className="hero-text ms-sm-5">
        <h1 className="caption mb-sm-3">Find the Best Deal On Your Dream Car</h1>
        <p className="details mb-sm-3 w-sm-75">We can help you find the best car. Check our reviews, compare models and find cars for sale.</p>
        <NavLink to="/all-cars">
